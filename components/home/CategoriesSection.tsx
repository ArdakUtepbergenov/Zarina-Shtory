...
const CATEGORIES = [
  ...
  },
  {
    id: 'tulle',
    label: 'Тюль',
    desc: 'Воздушные ткани, лён и тюльдер. Лёгкость и изысканность для любого интерьера',
  ...
  },
  {
    id: 'blinds',
    label: 'Жалюзи',
    desc: 'Рулонные, день-ночь, блэкаут. Идеальный контроль света в любом помещении',
