...
import { getWhatsAppLink, CATEGORY_LABELS } from '@/utils/helpers'
      ...
      <Link href={`/product/${product.id}`} className="block img-zoom relative aspect-[3/4] overflow-hidden bg-cream-100">
        ...
        <div className="absolute inset-0 bg-charcoal-900/0 group-hover:bg-charcoal-900/20 transition-all duration-300 flex items-end justify-center pb-4 opacity-0 group-hover:opacity-100">
          <a
            ...
            className="btn-gold text-white text-xs px-4 py-2 flex items-center gap-2 shadow-lg"
          >
      ...
      <div className="p-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-[10px] tracking-widest uppercase text-gold-500 hover:text-gold-700 font-medium transition-colors"
          >
            Узнать цену →
          </a>
        </div>
