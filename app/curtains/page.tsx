  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/90 flex items-center justify-center p-4" onClick={onClose}>
      <div className="relative w-full max-w-sm mx-auto" onClick={e => e.stopPropagation()}>
        <button onClick={onClose} className="absolute -top-10 right-0 text-white/70 hover:text-white text-sm font-body">
          Закрыть ✕
        </button>
    ...
    <div className="min-h-screen bg-cream-50 pt-20">
      ...
      <div className="bg-white border-b border-cream-200 py-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-[10px] tracking-[0.3em] uppercase text-gold-500 font-body">Zarina Шторы</span>
          </div>
          ...
          <p className="text-taupe-500 font-body text-sm max-w-lg">
            Шторы изготавливаются индивидуально под ваши окна. Посмотрите наши работы и свяжитесь с нами для замера.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10">
        ...
        <div className="bg-charcoal-900 p-6 sm:p-8 mb-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            <h2 className="font-display text-2xl font-light text-white mb-1">Пошив штор под любые окна</h2>
            <p className="text-taupe-400 font-body text-sm">Бесплатный выезд на замер · Любая сложность · Широкий выбор тканей</p>
          </div>
          <a
            href="https://wa.me/77018273334?text=Здравствуйте!%20Хочу%20заказать%20шторы."
        ...
        <div className="flex items-center gap-3 mb-6">
          <div className="h-px w-8 bg-gold-400" />
          <h2 className="font-display text-3xl font-light text-charcoal-900">Наши работы</h2>
        </div>
          ...
          {CURTAIN_VIDEOS.map((video) => (
            ...
            >
              <img
                ...
                loading="lazy"
              />
              <div className="absolute inset-0 bg-charcoal-900/30 group-hover:bg-charcoal-900/10 transition-all" />
              ...
              <div className="absolute top-2 right-2 bg-red-600 text-white text-[8px] font-bold px-1 py-0.5">SHORTS</div>
            </button>
          ))}
        </div>
        ...
        <div className="bg-white border border-cream-200 p-8 sm:p-10">
          <div className="flex items-center gap-3 mb-6">
            <div className="h-px w-8 bg-gold-400" />
            <h2 className="font-display text-2xl font-light text-charcoal-900">Как заказать шторы</h2>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            {[
              { step: '01', title: 'Напишите нам', desc: 'Опишите пожелания — размеры, стиль, ткань' },
              { step: '02', title: 'Бесплатный замер', desc: 'Мастер приедет и снимет точные мерки' },
              { step: '03', title: 'Пошив', desc: 'Изготовим шторы за 3–7 дней' },
              { step: '04', title: 'Монтаж', desc: 'Установим карнизы и повесим шторы бесплатно' },
            ].map((s) => (
              <div key={s.step} className="flex gap-4">
                <div className="font-display text-3xl font-light text-gold-300 shrink-0 leading-none">{s.step}</div>
                <div>
